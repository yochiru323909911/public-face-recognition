...
def find_landmarks(img, hog_face_detector, face_landmarks):
...
def detect_features(gray, hog_face_detector, face_landmarks):
    ...
    landmarks = find_landmarks(gray, hog_face_detector, face_landmarks)
    ...
    landmarks = find_landmarks(resized_img, hog_face_detector, face_landmarks)
...
def recognize_face(image_name, hog_face_detector, face_landmarks):
    ...
    # Detect facial features
    eyes, nose, mouth, eyebrow, jaw, gray = detect_features(gray)
