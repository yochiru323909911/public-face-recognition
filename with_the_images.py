...
def recognize(hog_face_detector, dlib_facelandmark, user1):
    ...
    for image_path in image_paths:
        print("-------------------------------------------------------")
        print(image_path)
        recognize_face(image_path, hog_face_detector, dlib_facelandmark)
    ...
    feature = 11
    # scatter plot
    plt.scatter(allvectors[feature][:len(f1)], np.zeros_like(allvectors[feature][:len(f1)]), c='b', label=user1)
    plt.scatter(allvectors[feature][len(f1):], np.zeros_like(allvectors[feature][len(f1):]), c='r', label=user2)
    plt.xticks(np.array(allvectors[feature]), [os.path.basename(path)[:-4] for path in image_paths + image_paths1], rotation=90)
...
if __name__ == "__main__":
    ...
    recognize(hog_face_detector, dlib_facelandmark, "b")
    recognize(hog_face_detector, dlib_facelandmark, "e")
    recognize(hog_face_detector, dlib_facelandmark, "l")
    recognize(hog_face_detector, dlib_facelandmark, "t")
    recognize(hog_face_detector, dlib_facelandmark, "y")

    recognize_face("faces/a1.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/a2.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/a5.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/b1.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/b2.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/b3.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/b4.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/b7.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/j1.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/j2.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/j6.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/j7.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/jb1.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/jb2.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/jb3.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/jb4.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/jons1.png", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/jons1.png", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/jons2.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/jons3.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/jons5.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/jons6.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/jons9.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/k1.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/k2.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/k3.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/k4.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/k5.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/k6.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/m1.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/m2.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/p1.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/p2.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/p3.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/p4.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/p5.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/w2.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/w5.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/w6.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/w8.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/w9.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/w11.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/w12.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/z1.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/z2.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/z3.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/z4.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/z5.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/zal1.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/zal6.jpg", hog_face_detector, dlib_facelandmark)
    recognize_face("faces/zal8.jpg", hog_face_detector, dlib_facelandmark)

    print("Average mi and max values of features:")
    for i in range(len(allvectors)):
        print(str(i) + ": average:", sum(allvectors[i])/len(allvectors[i]), ", min: ", min(allvectors[i]), ", max: ", max(allvectors[i]))

    print("Features values:")
    for i in range(len(allvectors)):
        print(str(i), ": ", allvectors[i])