...
if __name__ == "__main__":
    ...
    o = recognize("o", hog_face_detector, dlib_facelandmark)
    l = recognize("l", hog_face_detector, dlib_facelandmark)
    b = recognize("b", hog_face_detector, dlib_facelandmark)
    e = recognize("e", hog_face_detector, dlib_facelandmark)
    y = recognize("y", hog_face_detector, dlib_facelandmark)
    t = recognize("t", hog_face_detector, dlib_facelandmark)

    print("******************** comparing: *********************")
    compare_color_noses(o, b)
    compare_color_noses(l, e)
    compare_color_noses(l, y)
    compare_color_noses(l, t)
    compare_color_noses(b, e)
    compare_color_noses(b, y)
    compare_color_noses(b, t)
    compare_color_noses(e, y)
    compare_color_noses(e, t)
    compare_color_noses(y, t)
