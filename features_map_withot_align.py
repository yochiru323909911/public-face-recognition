...
def calculate_eccentricity(ellipse):
...
def extract_features(eyes, nose, mouth, eyebrow, jaw):
    ...
    jaw_ellipse = cv2.fitEllipse(np.array(jaw, dtype=np.float32))
    eccentricity = calculate_eccentricity(jaw_ellipse)
    features.append(eccentricity*100)
