...
# Main function
def recognize_face(image_a, image_b):
    image1, image2 = cv2.imread(image_a), cv2.imread(image_b)
    # Pre-process the images
    gray1 = cv2.cvtColor(image1, cv2.COLOR_BGR2GRAY)
    gray2 = cv2.cvtColor(image2, cv2.COLOR_BGR2GRAY)
    # Detect facial features
    eyes1, nose1, mouth1, eyebrow1, jaw1 = detect_features(gray1)
    eyes2, nose2, mouth2, eyebrow2, jaw2 = detect_features(gray2)

    print("----------------------------------------------------------\nfirst image: ")
    features1 = extract_features(eyes1, nose1, mouth1, eyebrow1, jaw1)

    print("----------------------------------------------------------\nsecond image: ")
    features2 = extract_features(eyes2, nose2, mouth2, eyebrow2, jaw2)

    # extract the skin color
    find_skin_color(image1, nose1, eyebrow1, jaw1)
    find_skin_color(image2, nose2, eyebrow2, jaw2)

    # extract the eyes color
    findEyesColor(image1, eyes1[LEFT], features1)
    findEyesColor(image2, eyes2[LEFT], features2)

    for row, feature in zip(allvectors, features1):  # every row is a specific feature
        row.append(feature)
    for row, feature in zip(allvectors, features2):  # every row is a specific feature
        row.append(feature)

    # normalizeRes()

    # Compare the features vectors
...
if __name__ == "__main__":
    print("distance: ", recognize_face("faces/z1.jpg", "faces/z2.jpg"))
    print("distance: ", recognize_face("faces/z5.jpg", "faces/z4.jpg"))
    print("distance: ", recognize_face("faces/j7.jpg", "faces/j2.jpg"))
    print("distance: ", recognize_face("faces/j1.jpg", "faces/j6.jpg"))
    """
    print("distance: ", recognize_face("faces/y1.jpg", "faces/y3.jpg"))
    print("distance: ", recognize_face("faces/y4.jpg", "faces/y5.jpg"))
    print("distance: ", recognize_face("faces/j7.jpg", "faces/j2.jpg"))
    print("distance: ", recognize_face("faces/j1.jpg", "faces/j6.jpg"))
    """
    ...
    values1 = allvectors[i][: len(allvectors[i])//2]
    for val in values1:
